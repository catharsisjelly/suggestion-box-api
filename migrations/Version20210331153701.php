 ...
 */
final class Version20210331153701 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE box (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', name VARCHAR(255) NOT NULL, start_datetime DATETIME DEFAULT NULL, end_datetime DATETIME DEFAULT NULL, is_open TINYINT(1) DEFAULT \'0\' NOT NULL, is_public TINYINT(1) DEFAULT \'0\' NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE suggestion (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', box_id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', suggestion_type_id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', value VARCHAR(255) NOT NULL, discarded TINYINT(1) DEFAULT \'0\' NOT NULL, created DATETIME NOT NULL, INDEX IDX_DD80F31BD8177B3F (box_id), INDEX IDX_DD80F31BAA96CFE7 (suggestion_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
